...
import { Popup, NavBar, Col, Row, Step, Steps, Notify, List, ActionSheet } from 'vant'
Vue.use(Popup).use(NavBar).use(Col).use(Row).use(Step).use(Steps).use(Notify).use(List).use(ActionSheet)
